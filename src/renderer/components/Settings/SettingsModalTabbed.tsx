...
const BUILT_IN_THEMES: Theme[] = [
  // Professional (most subtle first)
  {
    id: 'default',
    name: 'default',
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '12px', marginTop: '12px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  color: isDefaultFonts ? 'var(--fg-25)' : 'var(--fg-50)',
                  padding: '4px 12px',
                  borderRadius: '4px',
                  fontSize: '10px',
                  cursor: 'default',
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.color = isDefaultFonts ? 'var(--fg-25)' : 'var(--fg-50)';
                }}
              >
              ...
              {(showColorPicker === 'background' ? BACKGROUND_COLOR_ROWS :
                ...
                <div key={rowIndex} className="color-row">
                  {row.map(colorObj => (
                    <button
                      key={colorObj.hex}
                      className={`color-swatch ${showColorPicker === 'background' ? 'bg-swatch' : ''} ${
                        (showColorPicker === 'background' && colorObj.hex === backgroundColor) ||
