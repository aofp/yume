...
const BG_PRESETS = [
  ...
  ['#020202', '#0a0a08', '#0c0a0a', '#0a0c0c', '#0a0a0c', '#080808', '#0c0c0c', '#0e0e0e', '#101010', '#121212']
];
...
const FG_PRESETS = [
  ...
  ['#ffffff', '#c0c5ce', '#c6c8d1', '#f0f0f0', '#e7e7da', '#e8dcd0', '#c9d1d9', '#d6deeb', '#faf0d6', '#e0dbdb'],
...
const ACCENT_PRESETS = [
  ...
  ['#b6b6de', '#afff76', '#a78bfa', '#60a5fa', '#f472b6', '#4ade80', '#22d3ee', '#facc15', '#e879f9', '#fb923c']
];
...
const POSITIVE_PRESETS = [
  ...
  ['#c7f2cf', '#5affa9', '#4ade80', '#34d399', '#2dd4bf', '#22d3ee', '#a3e635', '#10b981', '#14b8a6', '#84cc16']
];
...
const NEGATIVE_PRESETS = [
  ...
  ['#ff9999', '#e06c75', '#e27878', '#f25d7a', '#ff74b9', '#df8383', '#ed6780', '#f47676', '#ef5350', '#f0423b'],
  // Row 2: More theme negatives + variations (void, grove, similar reds)
  ['#f09f9f', '#e67e80', '#f87171', '#fb7185', '#f472b6', '#ef4444', '#df2d53', '#dc2626', '#f43f5e', '#be123c']
];
