' Start yurucode with console window for debugging
...
' Force classic Command Prompt (not Windows Terminal) that closes when done
objShell.Run "cmd.exe /c node scripts/start-multi.js", 1, True
